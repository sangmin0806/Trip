...
import { loginFormSubmit, registerFormSubmit } from "@/assets/api/user";
...
const emit = defineEmits(['update:loginFormVisible', 'update:registerFormVisible', 'close', 'loginSuccess', 'registerSuccess']);
