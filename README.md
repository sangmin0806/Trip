...
🗓️ **프로젝트 기간**: 2024.04.15 ~ 2024.05.24

👥 **구성원**: 이상민, 최승호

 **소개**: 코로나 이후 늘어난 여행 수요와 함께 여행관련 서비스의 수요도 함께 증가하고 있습니다.

이에따라 여행계획, 추천, 후기등의 커뮤니티가 있는 플랫폼을 기획하게 되었습니다.

## 📌주요기능

- #### [국내 관광지 정보 조회]
  - 지역별 관광지 조회
  - 관광유형별(문화시설, 축제행사, 음식점, ...) 관광지 조회
...
- 로그인
  ...
  <img src="readmeImg/image-13.png" alt="로그인" width="500" height="400">

- 회원가입

  <img src="readmeImg/image-14.png" alt="회원가입" width="500" height="400">
